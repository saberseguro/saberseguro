...
import { buscarProgressoAulaController, iniciarCursoController, registrarAulaStepController, registrarUsuarioStepController, verificarConclusaoModuloController } from '../../controllers/curso/aulausuarioController';
...
router.post('/usuariostep', authorize(['ver_cursos']), registrarUsuarioStepController);
