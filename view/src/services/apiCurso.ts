...
export async function getCertificadoPreview(idCertificado: number): Promise<CertificadoDados> {
  return await apiFetch(`/curso/certificado/preview/${idCertificado}`);
}
